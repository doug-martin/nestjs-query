...
import { GraphQLQuery, GraphQLQueryType } from './query.type';
...
describe('QueryType', (): void => {
  ...
  // @ts-ignore
  @ArgsType()
  class TestQuery extends GraphQLQuery(TestDto) {}
...
type Query {
  findConnection(paging: GraphQLCursorPaging = {}, filter: TestQueryFilter = {}, sorting: [TestQuerySort!] = []): String!
}
...
`,
  ...
  it('should paging to the correct instance of paging', () => {
    const queryObj: GraphQLQueryType<TestDto> = {
      paging: {
        first: 10,
