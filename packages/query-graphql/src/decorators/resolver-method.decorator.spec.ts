...
import { ResolverMethod, ResolverMethodOptions } from './resolver-method.decorator';
...
describe('ResolverMethod decorator', (): void => {
  ...
  function createCanActivate(): nest.Type<nest.CanActivate> {
  ...
  function createInterceptor(): nest.Type<nest.NestInterceptor<any, any>> {
  ...
  function createPipe(): nest.Type<nest.PipeTransform<any, any>> {
  ...
  function createFilter(): nest.Type<nest.ExceptionFilter<any>> {
