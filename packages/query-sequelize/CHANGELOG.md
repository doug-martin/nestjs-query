...
* **sequelize:** Implement `setRelations` to set many
  relations ([b0c2d2f](https://github.com/tripss/nestjs-query/commit/b0c2d2f419ba2782f6b6e1290548cc8bf2afc699))
...
* **sequelize:** Update to support new aggregate with
  groupBy ([81fdef1](https://github.com/tripss/nestjs-query/commit/81fdef17304ad28a043f6a8e9a9496158e61022e))
...
* **sequelize:** Add additional filter options to
  QueryService ([29fdfa7](https://github.com/tripss/nestjs-query/commit/29fdfa724ec199835a6493b5f9cccb6bec58f074))
...
* **aggregations:** Add aggregation support to
  sequelize ([c37b7ae](https://github.com/tripss/nestjs-query/commit/c37b7aeb00fc60e7dc55893fe712dcad454edddb))
...
* **aggregations,sequelize:** Add relation aggregation to
  sequelize ([93e7c1b](https://github.com/tripss/nestjs-query/commit/93e7c1ba3d03b222b08f39bbbfaf4365ce50204e))
* **aggregations,sequelize:** Fix aggregation on many-to-many
  relations ([db6ecb2](https://github.com/tripss/nestjs-query/commit/db6ecb2527a96ba232c8af911e4eb2f6ab9f8a65))
...
* **sequelize:** Change query to not use sub
  queries ([80c69d6](https://github.com/tripss/nestjs-query/commit/80c69d6b285725eb99dc05675044185d2f4343a8))

### Features

* **sequelize:** Add support for querying for nested
  relations ([92a51c1](https://github.com/tripss/nestjs-query/commit/92a51c120aa2bf6da915037628aad041fa0fc34c))
...
* **sequelize:** Update sequelize package deps to match
  hoisted ([c7f5190](https://github.com/tripss/nestjs-query/commit/c7f5190ad1ae3d099cf9709eee36da188a455d13))
...
* **sequelize:** More clean up of
  code ([a72bce5](https://github.com/tripss/nestjs-query/commit/a72bce583862ed1902ee81974d7b530e7caac4d1))
