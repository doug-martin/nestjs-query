...
describe('SQLComparisonBuilder', (): void => {
  ...
  describe('is comparisons', () => {
    ...
    it('should throw an error for values other than null true or false', () => {
      // @ts-ignore
      expect(() => createSQLComparisonBuilder().build('boolType', 'is', 'foo', 'TestEntity')).toThrowError(
  ...
  describe('isNot comparisons', () => {
    ...
    it('should throw an error for values other than null true or false', () => {
      // @ts-ignore
      expect(() => createSQLComparisonBuilder().build('boolType', 'isNot', 'foo', 'TestEntity')).toThrowError(
