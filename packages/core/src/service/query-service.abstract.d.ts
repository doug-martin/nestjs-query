...
import { DeleteManyResponse, FindManyResponse, Query, UpdateManyResponse, UpdateOne, UpdateMany, DeleteOne, DeleteMany, CreateOne, CreateMany } from '../interfaces';
export declare abstract class AbstractQueryService<T> {
