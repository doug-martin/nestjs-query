...
Let's create a simple todo-item graphql example using `typeorm`.

[Click here to see a sequelize example!](https://github.com/doug-martin/nestjs-query/tree/master/examples/nest-graphql-sequelize)
