...
```ts
import { ConnectionType, SortType } from '@codeshine/nestjs-query-query-graphql';
...
import { FilterableField, QueryOptions, PagingStrategies } from '@codeshine/nestjs-query-query-graphql';
