...
* `enableSubscriptions?` - Set to `true` to enable graphql subscriptions. See [Subscriptions](./subscriptions).
...
* The following resolvers do not expose relations options, to add relations options see [Relateable](./relations#relatable)
:::
