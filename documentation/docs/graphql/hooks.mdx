...
```ts {7-10}
import { FilterableField, BeforeCreateOne, CreateOneInputType } from '@codeshine/nestjs-query-query-graphql';
...
import { BeforeCreateOneHook, CreateOneInputType } from '@codeshine/nestjs-query-query-graphql';
...
```ts {6}
import { FilterableField, BeforeCreateOne } from '@codeshine/nestjs-query-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
...
```ts {7-11}
import { FilterableField, BeforeCreateMany, CreateManyInputType } from '@codeshine/nestjs-query-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { GqlContext } from '../../interfaces';
import { getUserName } from '../../helpers';
...
```ts
import { Injectable } from '@nestjs/common';
import { BeforeCreateManyHook, CreateManyInputType } from '@codeshine/nestjs-query-query-graphql';
import { GqlContext } from './auth/auth.guard';
import { AuthService } from './auth/auth.service';
...
```ts {6}
import { FilterableField, BeforeCreateMany } from '@codeshine/nestjs-query-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { CreatedByHook } from '../../hooks';
...
```ts {7-10}
import { FilterableField, BeforeUpdateOne, UpdateOneInputType } from '@codeshine/nestjs-query-query-graphql';
...
```ts
import { BeforeUpdateOneHook, UpdateOneInputType } from '@codeshine/nestjs-query-query-graphql';
import { Injectable } from '@nestjs/common';
import { GqlContext } from './auth/auth.guard';
import { AuthService } from './auth/auth.service';
...
```ts {6}
import { FilterableField, BeforeUpdateOne } from '@codeshine/nestjs-query-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { CreatedByHook } from '../../hooks';
...
```ts {7-10}
import { FilterableField, BeforeUpdateMany, UpdateManyInputType } from '@codeshine/nestjs-query-query-graphql';
import { ObjectType } from '@nestjs/graphql';
import { GqlContext } from '../../interfaces';
import { getUserName } from '../../helpers';
...
```ts
import { BeforeUpdateManyHook, UpdateManyInputType } from '@codeshine/nestjs-query-query-graphql';
import { Injectable } from '@nestjs/common';
import { GqlContext } from './auth/auth.guard';
import { AuthService } from './auth/auth.service';
...
```ts {6}
import { FilterableField, BeforeUpdateMany } from '@codeshine/nestjs-query-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { CreatedByHook } from '../../hooks';
