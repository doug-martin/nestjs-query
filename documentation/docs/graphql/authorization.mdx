...
:::note
The following section assumes you are familiar with [authentication in nestjs](https://docs.nestjs
.com/techniques/authentication).
:::
...
* A `object` that has an `authorize` method that returns a Filter for the DTO.
