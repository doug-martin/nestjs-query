...
The `@codeshine/nestjs-query-graphql` package includes an `@Authorize` decorator that allows you to add additional filter
...
import { FilterableField, IDField, FilterableRelation, Authorize } from '@codeshine/nestjs-query-graphql';
...
import { Authorizer } from '@codeshine/nestjs-query-graphql';
...
import { Authorize, FilterableField, IDField, FilterableRelation } from '@codeshine/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { TodoItemDTO } from '../../todo-item/dto/todo-item.dto';
import { UserDTO } from '../../user/user.dto';
...
import { AuthorizerInterceptor, AuthorizerFilter, ConnectionType } from '@codeshine/nestjs-query-graphql';
...
import { CRUDResolver, InjectAuthorizer } from '@codeshine/nestjs-query-graphql';
...
```ts title='sub-task/sub-task.authorizer.ts'
import { Injectable } from '@nestjs/common';
import { CustomAuthorizer } from '@codeshine/nestjs-query-graphql';
import { Filter } from '@codeshine/nestjs-query-core';
import { UserContext } from '../auth/auth.interfaces';
import { SubTaskDTO } from './dto/sub-task.dto';
