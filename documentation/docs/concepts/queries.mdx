...
The core of `nestjs-query` is the `Query`, it is used by `@codeshine/nestjs-query-query-graphql`, `@codeshine/nestjs-query-query-typeorm`
`@codeshine/nestjs-query-query-sequelize`, `@codeshine/nestjs-query-query-mongoose` and `@codeshine/nestjs-query-query-typegoose`.
