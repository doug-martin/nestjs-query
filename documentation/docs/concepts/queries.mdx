...
The core of `nestjs-query` is the `Query`, it is used by `@codeshine/nestjs-query-graphql`, `@codeshine/nestjs-query-typeorm`
`@codeshine/nestjs-query-sequelize`, `@codeshine/nestjs-query-mongoose` and `@codeshine/nestjs-query-typegoose`.
